...
const noResults = (
  <ComponentContainer>
    <Text>Desculpe, sem resultados</Text>
  </ComponentContainer>
)

const noItems = (
  <ComponentContainer>
    <Text>Desculpe, sem itens</Text>
  </ComponentContainer>
)
...
class SectionedMultiSelect extends PureComponent {
  ...
  _filterItems = (searchTerm) => {
    ...
    searchTerm = this.toFilterString(searchTerm);
    ...
    const newData = items.filter((item) => {
      const itemData = this.toFilterString(this.getProp(item, displayKey));
      const textData = this.toFilterString(searchTerm);
